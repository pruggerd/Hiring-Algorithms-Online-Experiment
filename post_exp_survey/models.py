...
class Player(BasePlayer):
    ...
    choice1 = models.IntegerField(choices=[[1, 'Human evaluator'], [2, 'Algorithmic evaluator']])
    explanation = models.StringField()
    choice2 = models.IntegerField(choices=[[1, 'Human evaluator'], [2, 'Algorithmic evaluator']])
